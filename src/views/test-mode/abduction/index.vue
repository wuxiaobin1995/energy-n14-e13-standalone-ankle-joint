 ...
 * @LastEditTime: 2023-08-11 14:21:07
 * @Description : 外展
-->
<template>
  <div class="test-abduction">
    <div class="wrapper">
      <div class="title">踝关节活动度测试 - 外展</div>
...
export default {
  ...
  data() {
    return {
      ...
      showImg: require('@/assets/img/Test/外展.png'),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/test-abduction'),
