 ...
 * @LastEditTime: 2023-10-08 14:08:26
 * @Description : 外展-左
-->
<template>
  <div class="test-abduction-left">
    <div class="wrapper">
      <div class="title">踝关节活动度测试 - 外展（左）</div>
...
export default {
  ...
  data() {
    return {
      ...
      showImg: require('@/assets/img/Test/外展-左.png'),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/test-abduction-left'),
