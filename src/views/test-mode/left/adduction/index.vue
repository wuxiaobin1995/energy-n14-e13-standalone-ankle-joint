 ...
 * @LastEditTime: 2023-08-22 14:43:45
 * @Description : 内收-左
-->
<template>
  <div class="test-adduction-left">
    <div class="wrapper">
      <div class="title">踝关节活动度测试 - 内收（左）</div>
...
export default {
  ...
  data() {
    return {
      ...
      showImg: require('@/assets/img/Test/内收-左.png'),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/test-adduction-left'),
