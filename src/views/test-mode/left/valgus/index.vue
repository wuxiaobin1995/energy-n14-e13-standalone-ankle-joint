 ...
 * @LastEditTime: 2023-08-22 14:44:08
 * @Description : 外翻-左
-->
<template>
  <div class="test-valgus-left">
    <div class="wrapper">
      <div class="title">踝关节活动度测试 - 外翻（左）</div>
...
export default {
  ...
  data() {
    return {
      ...
      showImg: require('@/assets/img/Test/外翻-左.png'),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/test-valgus-left'),
