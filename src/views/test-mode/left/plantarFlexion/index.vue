 ...
 * @LastEditTime: 2023-08-22 14:38:22
 * @Description : 跖屈-左
-->
<template>
  <div class="test-plantarFlexion-left">
    <div class="wrapper">
      <div class="title">踝关节活动度测试 - 跖屈（左）</div>
...
export default {
  ...
  data() {
    return {
      ...
      showImg: require('@/assets/img/Test/跖屈-左.png'),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/test-plantarFlexion-left'),
