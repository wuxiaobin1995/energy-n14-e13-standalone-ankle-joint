 ...
 * @LastEditTime: 2023-08-22 14:44:30
 * @Description : 外展-右
-->
<template>
  <div class="test-abduction-right">
    <div class="wrapper">
      <div class="title">踝关节活动度测试 - 外展（右）</div>
...
export default {
  ...
  data() {
    return {
      ...
      showImg: require('@/assets/img/Test/外展-右.png'),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/test-abduction-right'),
