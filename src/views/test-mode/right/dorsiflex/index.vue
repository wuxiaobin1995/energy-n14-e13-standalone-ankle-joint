 ...
 * @LastEditTime: 2023-08-22 14:44:41
 * @Description : 背屈-右
-->
<template>
  <div class="test-dorsiflex-right">
    <div class="wrapper">
      <div class="title">踝关节活动度测试 - 背屈（右）</div>
...
export default {
  ...
  data() {
    return {
      ...
      showImg: require('@/assets/img/Test/背屈-右.png'),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/test-dorsiflex-right'),
